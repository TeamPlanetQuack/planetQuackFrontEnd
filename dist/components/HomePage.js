...
const HomePage = () => {
    ...
    return (React.createElement("div", { id: "homePage" },
        ...
        React.createElement("div", { className: "definition hidden", id: "dwarfDef" },
            "Dwarf Planet - an object in space that is similar to a planet but they do not have an orbital path that is clear of other materials",
            React.createElement(NavLink, { to: "/dwarfplanets" }, "Click Here to learn more about Dwarf Planets")),
