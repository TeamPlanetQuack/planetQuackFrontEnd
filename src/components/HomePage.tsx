...
const HomePage: React.FC = () => {
  ...
  function clickDidYouKnow() {
    const didYouKnowBefore: HTMLElement =
      document.getElementById("didYouKnowBefore")!;
    const didYouKnowAfter: HTMLElement =
      document.getElementById("didYouKnowAfter")!;
  ...
  return (
    <div id="homePage">
      ...
      <p>
        ...
        Neptune, and Uranus orbiting the Sun. There is also an asteroid belt
        between Mars and Jupiter. The asteroid belt contains thousands of space
        rocks that are not quite big enough to be planets themselves, but they
        also{" "}
        <span className="vocab" onClick={defineOrbit}>
          orbit
        </span>{" "}
        our sun.
      </p>
      ...
      <div className="didYouKnow" onClick={clickDidYouKnow}>
        {" "}
        <div className="dYK">?</div>
        <div id="didYouKnowBefore">Did You Know ?</div>
        <div className="hidden" id="didYouKnowAfter">
          In the past, humans thought the Earth was the center of the Universe
          and that all other planets and the sun orbited the Earth. This is easy
          to understand because from our perspective it does look like the sun
          is rotating around us, rising in the East and setting in the West.
          This was known as geocentric theory. We now know that the sun is the
          center of our solar system, and this is known as Heliocentric theory.
        </div>
      </div>
      <p>
        ...
        spiral shaped{" "}
        <span className="vocab" onClick={defineGalaxy}>
          galaxy
        </span>
        .
      </p>
      ...
      <p>
        ...
        <span className="vocab" onClick={defineDwarf}>
          dwarf planets
        </span>{" "}
        in our solar system that don't quite meet the definition of a planet.
        Many of the dwarf planets in our solar system, including Pluto, extend
        deep into the Kuiper Belt. The Kuiper Belt is the deepest reaches of our
      ...
      <div className="definition hidden" id="dwarfDef">
        ...
        <NavLink to="/dwarfplanets">
          Click Here to learn more about Dwarf Planets
        </NavLink>
      </div>
      ...
      <div id="quizContainer">
        <p>
          ...
          exploring the different planets and moons in the solar system{" "}
          <NavLink to="/quiz">try this quiz</NavLink> to see what you've
          learned!
        </p>
      </div>
      <Footer />
